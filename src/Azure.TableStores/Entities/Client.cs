...
namespace SpringComp.IdentityServer.TableStorage.Entities
{
    public class Client : TableEntity
    {
        ...
        public Client(string clientId)
            : base(Partition, clientId)
        {
        }

        public static string Partition = "client";
     ...
     //1   public List<ClientSecret> ClientSecrets { get; set; }
     //2   public List<ClientGrantType> AllowedGrantTypes { get; set; }
     //3   public List<ClientScope> AllowedScopes { get; set; }
     //4   public List<ClientRedirectUri> RedirectUris { get; set; }
     //5   public List<ClientPostLogoutRedirectUri> PostLogoutRedirectUris { get; set; }
